...
cvKNN = function(dataSet, foldNum) {
    ...
    # ML: commented out the following line and call knn with train_df directly to get training error
    #result$train.cvError = cvKNNAveErrorRates[bestK_index]
    result$train.cvError = sum(knn(train_df, train_df, train_df$y, k = result$bestK) != train_df$y) / nrow(train_df)
