...
```{r}
error_df = data.frame(matrix(c(mean(linearTrainErr$errorRate),mean(linearTestErr$errorRate),mean(quadTrainErr$errorRate),mean(quadTestErr$errorRate),mean(knnTrainErr$errorRate),mean(knnTestErr$errorRate),mean(bayesTrainErr$errorRate),mean(bayesTestErr$errorRate)),ncol = 2))

colnames(error_df) = c("mean_train_error","mean_test_error")
