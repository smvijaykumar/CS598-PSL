...
```{r}
error_df = data.frame(matrix(c(mean(linearTrainErr$errorRate),mean(linearTestErr$errorRate),min(linearTrainErr$errorRate),min(linearTestErr$errorRate),mean(quadTrainErr$errorRate),mean(quadTestErr$errorRate),min(quadTrainErr$errorRate),min(quadTestErr$errorRate),mean(knnTrainErr$errorRate),mean(knnTestErr$errorRate),min(knnTrainErr$errorRate),min(knnTestErr$errorRate),mean(bayesTrainErr$errorRate),mean(bayesTestErr$errorRate),min(bayesTrainErr$errorRate),min(bayesTestErr$errorRate)),ncol = 4))
