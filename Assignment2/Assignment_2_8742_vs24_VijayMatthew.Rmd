...
on the Boston housing data. The goal is to check the accuracy of our implementation compare to the output of glmnet.The maximum diference between the two coefficient matrices should be less than 0.005.
