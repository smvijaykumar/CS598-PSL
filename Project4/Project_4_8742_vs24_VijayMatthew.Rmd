...
for (u in 1:nrow(test)){
    ...
    POPULAR_test.pred$rating[u] = ifelse(movieid %in% names(AVG_POPULAR_recom), AVG_POPULAR_recom[[movieid]], 2.5) 
}
...
for (u in 1:nrow(test)){
    ...
    # handle missing values; 2.5 might not be the ideal choice
    HYBRID_test.pred$rating[u] = ifelse(is.na(rating), 2.5, rating)
}
