...
Since one full run takes about 1 hour on a MSI Intel i7 16G memory laptop on the full dataset of ratings, we speed up the processing of this markdown document by running a reduced dataset (10% of full dataset) on this session. 

We manually distibuted the run of 10 iterations in separate machines to speed up processing and collect results in the following full dataset result table below.
...
Running time of 1 iterations for full dataset:

```{r echo=FALSE}

kable(data.frame(SystemI_Avg_Popular="3.057058 secs", SystemI_Hybrid="30.12208 mins", SystemII_UBCF="19.01733 mins", SystemII_IBCF="6.242121 secs"))
